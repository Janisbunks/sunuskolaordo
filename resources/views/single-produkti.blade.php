      ...
      >
        ...
        >
          ...
          <div class="p-6">
            ...
            <img
              src="{{ home_url('/content/uploads/2026/04/ordo-izmeru-tabula.jpg') }}"
              alt="Izmēru tabula"
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-16">
        <div class="grid lg:grid-cols-2 gap-8 lg:gap-16">
          ...
          <div class="lg:sticky lg:top-8 h-fit">
            <div
              class="aspect-square w-full max-w-[400px] md:only:max-w-[500px] overflow-hidden rounded-2xl bg-gray-50 mx-auto"
            >
          ...
          <div class="flex flex-col">
            {{-- Product Title --}}
            <h1 class="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-3">{{ get_the_title() }}</h1>
                  ...
                  <div class="grid grid-cols-3 sm:grid-cols-4 gap-2">
                    @foreach ($sizes as $size)
                      ...
                      <label class="cursor-pointer">
                        <input type="radio" name="size" value="{{ $size }}" x-model="selectedSize" class="sr-only" />
                        <div
                          class="h-full flex flex-col items-center justify-center px-4 py-3 rounded-lg border-2 transition-all duration-150"
