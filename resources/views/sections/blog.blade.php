...
<section class="py-16 relative bg-gradient-to-br from-gray-50 to-white overflow-hidden">
  ...
  <div class="absolute inset-0">
    <div
      class="absolute top-0 right-0 w-64 h-64 bg-blue-100/30 rounded-full blur-3xl translate-x-1/2 -translate-y-1/2"
    ></div>
    <div
      class="absolute bottom-0 left-0 w-80 h-80 bg-orange-100/20 rounded-full blur-3xl -translate-x-1/2 translate-y-1/2"
    ></div>
  </div>
  ...
  <div class="{{$container}} relative z-10">
    ...
    <div class="text-center mb-12">
      ...
      <h2 class="text-4xl lg:text-5xl font-bold text-gray-900 leading-tight mb-4">Jaunākie Raksti</h2>
      <p class="text-lg text-gray-600 max-w-2xl mx-auto">Noderīgi padomi un informācija par suņu apmācību un uzvedību</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
      @hasposts
        @posts
          <a
            href="@permalink"
            class="group block bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 hover:border-orange-200"
            title="@title"
            aria-label="@title"
          >
            <!-- Image container -->
            <div class="relative overflow-hidden aspect-[4/3]">
              ...
              <div class="absolute top-4 left-4 z-20">
                <span
                  class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-white/90 backdrop-blur-sm text-gray-700"
                >
                  Raksts
                </span>
              </div>
            ...
            <div class="p-6">
              ...
              <!-- Title -->
              <h3
                class="text-xl font-bold text-center text-gray-900 mb-3 line-clamp-2 group-hover:text-orange-600 transition-colors duration-300"
              >
                @title
              </h3>
              ...
              <div class="flex items-center justify-between">
                <span
                  class="text-orange-600 font-medium text-sm group-hover:text-orange-700 transition-colors duration-300"
                >
                  Lasīt vairāk
                </span>
