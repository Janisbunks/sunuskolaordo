  ...
  <div class="container relative mx-auto px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="text-center mb-4 lg:mb-16">
        <div class="inline-flex items-center space-x-2 text-orange-400 font-medium text-sm uppercase tracking-wider mb-4">
        ...
        <p class="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
          Sazinieties ar mani, lai noskaidrotu vairāk par suņu apmācības pakalpojumiem
        </p>
      </div>
      <div class="relative group max-w-[800px] w-full mx-auto">
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl p-4 shadow-xl border border-white/20 hover:border-rose-200/50 transition-all duration-300">
          <div class="absolute inset-0 bg-gradient-to-br from-rose-50/50 to-pink-50/50 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
