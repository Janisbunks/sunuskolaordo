  ...
  <div class="container relative mx-auto px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="text-center mb-16">
        ...
        <h2 class="text-4xl lg:text-5xl font-bold text-white/90 leading-tight mb-6">Nodarbību piedāvājums</h2>
        <p class="text-xl text-white/90 max-w-3xl mx-auto leading-relaxed">Profesionālas suņu apmācības un socializācijas nodarbības, kas palīdzēs jūsu četrkājainajam draugam kļūt par labāko versiju</p>
      </div>
        ...
        @endphp
            ...
            <div class="group relative">
              ...
              >
                ...
                <div
                  class="absolute inset-0 bg-gradient-to-br from-blue-500/10 to-indigo-500/10 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                ></div>
                ...
                <div class="relative z-10">
                  ...
                  <div class="mt-4 flex justify-center">
                    <div
                      class="w-6 h-6 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 transform group-hover:scale-110"
                    >
      ...
      <div class="text-center mt-16 w-fit mx-auto">
        <div class="bg-white rounded-2xl p-8 shadow-lg border border-white/10">
          <h3 class="text-2xl font-bold text-black mb-4">Vai vēlaties uzzināt vairāk?</h3>
          <p class="text-black mb-6 max-w-2xl mx-auto">Sazinieties ar mums, lai noskaidrotu, kura nodarbība ir vispiemērotākā jūsu suņa vajadzībām</p>
          <!-- From Uiverse.io by Mubashir222 -->
          <a
            href="{{get_permalink(52)}}"
