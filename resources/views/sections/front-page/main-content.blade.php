      ...
      <div class="space-y-8">
        ...
        <div class="space-y-4">
          ...
          <h2 class="text-4xl lg:text-5xl font-bold text-gray-900 leading-tight">
            Agnese Bunka
            <span class="block text-2xl lg:text-3xl font-normal text-orange-600 mt-2">Suņu Trenere & Uzvedības Speciāliste</span>
          </h2>
        </div>

        <!-- Modern content with better typography -->
        <div class="prose prose-lg max-w-none">
          <p class="text-gray-700 leading-relaxed text-lg">
            Mans vārds ir <strong class="text-gray-900">Agnese Bunka</strong>. Esmu suņu apmācību trenere un suņu uzvedības speciāliste. Suņu apmācību jomā darbojos jau ceturto gadu.
          </p>
          ...
          <div class="mt-6 space-y-4">
            <div class="flex items-center space-x-3">
              ...
              <p class="text-gray-700 leading-relaxed mb-0">
                Kinoloģijas nozarē sāku izglītoties 2013. gadā, kad iestājos un pabeidzu Latvijas Kinoloģiskās federācijas piedāvātos kursus "Kinoloģijas pamati".
              </p>
            </div>
            ...
            <div class="flex items-center space-x-3">
              <div class="w-3 h-3 bg-orange-400 rounded-full flex-shrink-0 animate-pulse"></div>
              <p class="text-gray-700 leading-relaxed mb-0">
                2017. gadā ieraudzīju reklāmu suņu treneru apmācību kursam Igaunijā, kuras organizēja Norvēģijas suņu skola Nordic Dog Trainer School.
              </p>
            </div>
            ...
            <div class="flex items-center space-x-3">
              <div class="w-3 h-3 bg-orange-400 rounded-full flex-shrink-0 animate-pulse"></div>
              <p class="text-gray-700 leading-relaxed mb-0">
                2020. gadā sāku praktizēt kā suņu apmācību trenere PetCity suņu skolā, kurā arī ieguvu praktiskās zināšanas.
              </p>
            </div>
            ...
            <div class="flex items-center space-x-3">
              <div class="w-3 h-3 bg-orange-400 rounded-full flex-shrink-0 animate-pulse"></div>
              <p class="text-gray-700 leading-relaxed mb-0">
                2023. gads nāca ar ļoti lielu prieku, jo beidzot durvis vēra manis pašas suņu skola <strong class="text-orange-600">ORDO</strong>.
              </p>
            </div>
          </div>
        </div>
