<footer
  class="py-8 relative bg-black overflow-hidden"
  style="background: linear-gradient(135deg, #1e293b 0%, #0f172a 50%, #020617 100%)"
>
  <!-- Modern background elements -->
  <div class="absolute inset-0">
    <div
      class="absolute top-0 right-0 w-96 h-96 bg-gradient-to-bl from-blue-400/10 to-indigo-400/10 rounded-full blur-3xl translate-x-1/2 -translate-y-1/2"
    ></div>
    <div
      class="absolute bottom-0 left-0 w-80 h-80 bg-gradient-to-tr from-indigo-400/8 to-blue-400/8 rounded-full blur-3xl -translate-x-1/2 translate-y-1/2"
    ></div>
    <div
      class="absolute top-1/2 left-1/2 w-64 h-64 bg-gradient-to-r from-blue-300/5 to-indigo-300/5 rounded-full blur-2xl -translate-x-1/2 -translate-y-1/2"
    ></div>
  </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
      ...
      <div class="lg:col-span-6">
        <div class="space-y-6">
          ...
          <p class="text-gray-300 leading-relaxed">Profesionāla suņu apmācība un uzvedības korekcija. Palīdzam jums un jūsu mīlulim kļūt par labāko komandu!</p>
      ...
      <div class="lg:col-span-3">
        <div class="space-y-6">
          ...
          <div class="space-y-3">
            ...
            >
              <div
                class="w-6 h-6 bg-gradient-to-r from-orange-500 to-red-500 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300 flex-shrink-0"
              >
    ...
    >
      ...
      >
        ...
        <div class="text-center space-y-3 mb-8">
          <p class="text-lg text-gray-700">Jūsu pasūtījums ir veiksmīgi iesniegts!</p>
          <p class="text-gray-600">Rēķins ir nosūtīts uz jūsu e-pastu.</p>
          <p class="text-gray-600">Sazināsimies ar jums <strong class="text-emerald-600">1-2 darba dienu</strong> laikā, lai apstiprinātu pasūtījumu un piegādes detaļas.</p>
        </div>
