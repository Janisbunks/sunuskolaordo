    ...
    <div class="max-w-4xl mx-auto px-6">
        ...
        <template x-if="Object.keys(cart).length === 0">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-12 text-center">
                ...
                <a href="{{ url('/') }}" class="inline-block bg-emerald-600 text-white px-8 py-3 rounded-xl font-semibold hover:bg-emerald-700 transition">
                    Turpināt Iepirkties
                </a>
            </div>
        </template>
                            ...
                            <div class="flex items-center gap-6">
                                ...
                                <div class="w-24 h-24 bg-gray-100 rounded-xl overflow-hidden flex-shrink-0">
                                    <template x-if="productData[cartKey]?.image">
                                        <img :src="productData[cartKey].image"
                                ...
                                {{-- Product Info --}}
                                <div class="flex-1">
                                    <h3 class="font-semibold text-lg text-gray-900 mb-1" x-text="productData[cartKey]?.title || 'Product'"></h3>
                                ...
                                <div class="flex items-center gap-3">
                                    <div class="inline-flex items-center overflow-hidden border border-gray-400 rounded-2xl">
                                        <button @click="updateQuantity(cartKey, Math.max(1, item.quantity - 1))"
                                        ...
                                        <button @click="updateQuantity(cartKey, item.quantity + 1)"
                                                class="px-4 py-2 hover:bg-gray-50 transition-colors text-gray-600 hover:text-gray-900">
                                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <p class="text-lg mb-0 font-bold text-gray-900 w-24 text-right" x-text="(item.price * item.quantity).toFixed(2) + ' €'"></p>

                                    <button @click="removeItem(cartKey)"
